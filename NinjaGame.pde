...
class NinjaLevel extends Level 
{
   NinjaLevel(float levelWidth, float levelHeight) 
   {
      super(levelWidth, levelHeight);
		addScreenLayer("my level layer", new NinjaLevelLayer(this));
   }
}

class NinjaLevelLayer extends LevelLayer 
{
  NinjaLevelLayer(Level owner) 
	{
    super(owner);
...
class NinjaPlayer extends Player 
{
	 NinjaPlayer() 
	 {
    super("ninja");
